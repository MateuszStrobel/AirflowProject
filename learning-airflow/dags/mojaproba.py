...
def moja_proba():
    ...
    @task
    def Mojazabawa(greeting: str, person_in_space: dict) -> None:
        """
        This task creates a print statement with the name of an
        Astronaut in space and the craft they are flying on from
        the API request results of the previous task, along with a
        ...
        print(f"{name} is in space flying on the {craft}! {greeting} To jest moja zmiana, zastawiam sie co zrobic zbey to dzialo")
